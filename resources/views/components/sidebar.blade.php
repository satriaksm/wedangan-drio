<nav class="bg-primary border-gray-200 dark:bg-white fixed top-0 z-50 w-full border-b">
    <div class="max-w-screen-3xl flex flex-wrap items-center justify-between py-2 sm:py-[10px] w-full px-2 md:px-4">
        <div class="flex gap-2">
            ...
            class="ms-4 inline-flex items-center p-2 text-sm text-white rounded-lg sm:hidden hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
  ...
  <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 pt-12 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-primary  dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <button type="button" class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-secondary dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
             ...
             <ul id="dropdown-example" class="hidden py-2 space-y-2">
                   <li>
                      <a href="/categories" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-secondary dark:text-white dark:hover:bg-gray-700">Kategori</a>
                   </li>
                   <li>
                      <a href="/products" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-secondary dark:text-white dark:hover:bg-gray-700">Produk</a>
                   </li>
                   <li>
                      <a href="/users" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-secondary dark:text-white dark:hover:bg-gray-700">Users</a>
                   </li>
             </ul>
          </li>
          <li>
             <a href="/history" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-secondary dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Riwayat Pembelian</span>
             </a>
          </li>
          <li>
