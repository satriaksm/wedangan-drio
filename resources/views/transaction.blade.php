...
<div x-data="{
            ...
            <button class="group container card flex mb-2 items-center bg-white hover:bg-tertiary hover:text-white justify-between px-3 py-2 rounded-xl shadow"
                ...
                <div class="box flex items-center gap-x-3">
                    ...
                    <div class="flex flex-col justify-between ">
                        <h1 class="menu-item dark:text-white group-hover:text-white text-primary sm:text-base text-sm sm:font-medium text-left" x-text="product.name"></h1>
    ...
    <!-- Bottom Bar -->
    <div class="fixed bottom-0 left-0 right-0 px-5 lg:ps-[307px]">
